import "../WhyChoose/WhyChoose.Style.css";
import WhyChooseQuality from "../WhyChoose/WhyChoose-Images/WhyChoose.png";

const WhyChoose = () => {
  return (
    <div className="WhyChoose-Container">
      <p className="Advantage">The ClearLink Advantage</p>
      <p className="Heading">Why choose ClearLink?</p>
      <p className="Content">
      ...
      <div className="Quality">
        <div className="Col">
          <div className="Cards">
            ...
            <h6 className="Title">Crystal-clear HD video</h6>
            <p>
          ...
          <div className="Cards">
            ...
            <h6 className="Title">Noise-canceling audio</h6>
            <p>
          ...
          <div className="Cards">
            ...
            <h6 className="Title">Scheduling made easy</h6>
            <p>
          ...
          <div className="Cards">
            ...
            <h6 className="Title">Bank-grade security</h6>
            <p>
